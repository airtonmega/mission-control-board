...
@pytest.mark.anyio
async def test_analyze_image_error_returns_structured(client, mock_openai_service):
    ...
    mock_openai_service.analyze_image = AsyncMock(side_effect=err)
...
@pytest.mark.anyio
async def test_analyze_audio_error_returns_structured(client, mock_openai_service):
    ...
    mock_openai_service.analyze_audio = AsyncMock(side_effect=err)
...
@pytest.mark.anyio
async def test_analyze_text_ai_response_error_returns_422_structured(client, mock_openai_service):
    ...
    mock_openai_service.analyze_text = AsyncMock(side_effect=err)
...
@pytest.mark.anyio
async def test_analyze_text_service_unavailable_returns_503_structured(client, mock_openai_service):
...
@pytest.mark.anyio
async def test_analyze_text_error_detail_has_required_fields(client, mock_openai_service):
